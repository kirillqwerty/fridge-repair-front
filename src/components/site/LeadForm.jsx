...
export default function LeadForm({
  ...
  const setPhone = (event) => {
    ...
    setForm((s) => ({
      ...s,
      phone: formatBelarusPhone(value, s.phone, selectionStart),
    }));
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 relative">
            <div className="lg:col-span-5">
              ...
              <p className="mt-3 text-base text-muted-foreground leading-relaxed">
                {subtitle ||
                  "Оставьте заявку — перезвоним за 2–3 минуты, назовём точную цену, приедем в день звонка."}
              </p>

              <ul className="mt-6 space-y-3 text-sm">
                <li className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-primary" />
                  Диагностика 30 BYN — бесплатно при ремонте
                </li>
              ...
              <div className="mt-6 inline-flex items-center gap-2 text-sm">
                ...
                <a
                  ...
                  data-testid="lead-section-phone"
                >
                  {phone}
                </a>
              </div>
            ...
            >
              ...
              <div className="sm:col-span-1">
                ...
                >
                  <SelectTrigger
                    id="brand"
                    data-testid="lead-form-brand-select"
                  >
              ...
              <div className="sm:col-span-1">
                ...
                <Select
                  value={form.problem || undefined}
                  onValueChange={(v) => set("problem", v)}
                >
                  <SelectTrigger
                    id="problem"
                    data-testid="lead-form-problem-select"
                  >
              ...
              <div className="sm:col-span-2">
                ...
                <Textarea
                  ...
                  data-testid="lead-form-problem-textarea"
                />
              </div>
              ...
              <div className="sm:col-span-2 flex items-start gap-3 text-xs text-muted-foreground">
                ...
                <label htmlFor="consent" className="leading-relaxed">
                  Я согласен на обработку персональных данных и на связь по
                  указанному телефону.
                </label>
              </div>
              ...
              <div className="sm:col-span-2 flex flex-col sm:flex-row gap-3">
                <Button
                  type="submit"
                  disabled={submitting}
                  className="h-12 px-6 sm:flex-1 gap-2"
                ...
                <a href={formatPhoneHref(phone)} className="sm:flex-1">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-12 px-6 gap-2 border-border"
                    data-testid="lead-form-call-button"
                  >
              ...
              {done && (
                <div
                  className="sm:col-span-2 p-4 rounded-xl bg-primary/10 border border-primary/20 text-sm text-foreground flex items-start gap-3"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-foreground/80 mt-0.5">
                      Мы перезвоним вам в ближайшее время на указанный номер.
                      Если срочно — звоните сами: {phone}
                    </div>
                  </div>
                </div>
              )}
